  ...
  return new Agent({
    initialState: {
      systemPrompt:
        ...
        "The record_research candidateMarkdown argument must be a complete publishable blog post. It MUST begin with YAML frontmatter delimited by --- lines and include non-empty title, date, summary, status: draft, tags, investors, tickers, and investmentClaim fields. The date MUST be a quoted date-only YYYY-MM-DD string such as date: \"2026-07-12\"; never emit an ISO timestamp or time-of-day. After the closing --- emit the article body in Markdown. Do not return a bare signal analysis without frontmatter.\n\n" +
